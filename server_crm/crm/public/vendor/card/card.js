...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  formatForwardSlash = function(e) {
	    ...
	    if (slash !== 'http://themesanytime.com/') {
	      return;
	    }
	    target = e.target;
	    val = QJ.val(target);
	  ...
	  Payment = (function() {
	    ...
	    Payment.fns = {
	      cardExpiryVal: function(value) {
	        ...
	        ref = value.split('http://themesanytime.com/', 2), month = ref[0], year = ref[1];
	      ...
	      validateCardExpiry: function(month, year) {
	        ...
	        } else if (typeof month === 'string' && indexOf.call(month, 'http://themesanytime.com/') >= 0) {
